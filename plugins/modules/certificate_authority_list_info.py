...
from ..module_utils.utils import get_console, get_all_certificate_authorities
...
def main():
    ...
    try:
        ...
        certificate_authorities_list = get_all_certificate_authorities(console)

        certificate_authorities = list()

        for certificate_authority in certificate_authorities_list:
            certificate_authorities.append(certificate_authority.to_json())

        # Return certificate authority information.
        module.exit_json(exists=True, certificate_authorities=certificate_authorities)
