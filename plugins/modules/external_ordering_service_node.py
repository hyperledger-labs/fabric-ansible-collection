...
DOCUMENTATION = '''
---
module: external_ordering_service_node
short_description: Manage an external Hyperledger Fabric ordering service node
description:
...
def main():
    ...
    argument_spec = dict(
        ...
        name=dict(type='str'),
        ordering_service_node=dict(type='dict', options=dict(
            name=dict(type='str'),
    ...
    required_if = [
        ...
        ('state', 'present', ['ordering_service_node']),
        ('state', 'absent', ['name'])
    ]
    mutually_exclusive = [
    ...
    try:
        ...
        ordering_service_node_definition = module.params['ordering_service_node']
        ...
        if ordering_service_node_exists:
            ...
            if has_deployment_attrs or has_location:
                raise Exception('Ordering service node exists and appears to be managed by this console, refusing to continue')
        ...
        expected_ordering_service_node = dict(
            display_name=ordering_service_node_definition['name'],
            api_url=ordering_service_node_definition['api_url'],
