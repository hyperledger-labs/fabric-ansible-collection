...
short_description: Update metadata for a Hyperledger Fabric certificate authority
description:
...
def main():
    ...
    try:
        ...
        peer = console.get_component_by_display_name('fabric-peer', module.params['name'], deployment_attrs='included')
